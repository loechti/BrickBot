...
"that is transparent",
"for NASA",
"that your parents would use",
"that can be placed in you home town"
		];
var bricks = [
"using only 10 bricks",
"using at least 20 bricks",
"using only red bricks",
"using only yellow bricks",
"using at least one pink brick",
"using at least one black brick",
"using at least one yellow brick",
"using only plates",
];
